...
icon = Image.open("Input files/Phonepe logo.png")
...
st.sidebar.markdown("<p style='color: violet; font-size: 24px;'><strong>Hello! Welcome to the dashboard</strong></p>", unsafe_allow_html=True)
...
if selected == "Home":
    st.image("Input files/Phonepe pulse logo.png")
    st.markdown("<h1><span style='color: violet;'>Data Visualization and Exploration</span></h1>", unsafe_allow_html=True)
    st.markdown("<h2><span style='color: violet;'>A User-Friendly Tool Using Streamlit and Plotly</span></h2>", unsafe_allow_html=True)
    col1,col2 = st.columns([3,2],gap="medium")
    with col1:
    	st.write(" ")
    	st.write(" ")
    	st.markdown("<h3><span style='color: violet;'>Domain:</span> Fintech</h3>", unsafe_allow_html=True)
    	st.markdown("<h3><span style='color: violet;'>Technologies used: </span>Github Cloning, Python, Pandas, MySQL, mysql-connector-python, Streamlit, and Plotly.</h3>", unsafe_allow_html=True)
    	st.markdown("<h3><span style='color: violet;'>Overview: </span>In this streamlit web app you can visualize the phonepe pulse data and gain lot of insights on transactions, number of users, top 10 state, district, pincode and which brand has most number of users and so on. Bar charts, Pie charts and Geo map visualization are used to get some insights.</h3>", unsafe_allow_html=True)
    with col2:
    	st.image("Input files/Phonepe Pulse.jpg")


if selected == "Top Charts":
    st.markdown("<h2><span style='color: violet;'>Top Charts</span></h2>", unsafe_allow_html=True)
    ...
    if Type == "Transactions":
        ...
        with col1:
            st.markdown("<h3><span style='color: violet;'>State</span></h3>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("<h3><span style='color: violet;'>District</span> </h3>", unsafe_allow_html=True)
        ...
        with col3:
            st.markdown("<h3><span style='color: violet;'>Pincode</span> </h3>", unsafe_allow_html=True)
    ...
    if Type == "Users":
        ...
        with col1:
            st.markdown("<h3><span style='color: violet;'>Brands</span></h3>", unsafe_allow_html=True)
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            st.markdown("<h2><span style='color: violet;'>Overall State Data Transaction Amount</span></h2>", unsafe_allow_html=True)
            ...
            df2 = pd.read_csv('Input files/Statenames.csv')
            df1.State = df2
        ...
        with col2:          
            st.markdown("<h2><span style='color: violet;'>Overall State Data Transaction Count</span></h2>", unsafe_allow_html=True)
            mycursor.execute(f"select state, sum(count) as Total_Transactions, sum(amount) as Total_amount from map_transaction where year = {Year} and quarter = {Quarter} group by state order by state")
            df1 = pd.DataFrame(mycursor.fetchall(),columns= ['State', 'Total_Transactions', 'Total_amount'])
            df2 = pd.read_csv('Input files/Statenames.csv')
...
# BAR CHART - TOP PAYMENT TYPE
        st.markdown("<h2><span style='color: violet;'>Top Payment Type</span></h2>", unsafe_allow_html=True)
...
# BAR CHART TRANSACTIONS - DISTRICT WISE DATA            
        ...
        st.markdown("# ")
        st.markdown("# ")
        st.markdown("<h2><span style='color: violet;'>Select any state to explore</span></h2>", unsafe_allow_html=True)
    ...
    if Type == "Users":
        st.markdown("<h2><span style='color: violet;'>Overall State Data User App Opening Frequency</span></h2>", unsafe_allow_html=True)
